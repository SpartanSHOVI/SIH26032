    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="booking-state" className="block text-xs font-semibold text-gray-700 mb-1">State</label>
                <select
                  id="booking-state"
                  aria-label="State"
                  value={selectedState}
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white font-medium focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:outline-none"
                >
                  {states.map((s: string) => (
              ...
              <div>
                <label htmlFor="booking-district" className="block text-xs font-semibold text-gray-700 mb-1">District</label>
                <select
                  id="booking-district"
                  aria-label="District"
            ...
            <div className="pt-2 space-y-2 border-t border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <label htmlFor="booking-mandi-search" className="text-xs font-semibold text-gray-700 flex items-center gap-1.5">
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    id="booking-mandi-search"
                    type="text"
                    aria-label="Search mandi name or code"
                  ...
                  {centers.map((c: any) => {
                    ...
                    return (
                      <div
                        ...
                        aria-label={`Select mandi ${c.name} (${c.code})`}
                        ...
                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:outline-none ${
                          isSelected
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div>
              <label htmlFor="booking-date" className="block text-xs font-semibold text-gray-700 mb-1">
                Select Procurement Date
              </label>
              <input
                id="booking-date"
                aria-label="Select Procurement Date"
                type="date"
                min={getLocalDateString()}
                value={selectedDate}
                onChange={(e) => setSelectedDate(e.target.value)}
                className="w-full sm:w-64 px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white font-medium focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:outline-none"
              />
            </div>
                  ...
                  {slots.map((s: any) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={s.full}
                        aria-pressed={isSelected}
                        aria-label={`Time slot ${s.start_time} to ${s.end_time}, ${s.full ? 'full' : `${s.remaining} slots remaining`}`}
                        onClick={() => setSelectedSlotId(s.id)}
                        className={`p-3 rounded-lg border-2 text-left transition-all focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:outline-none ${
                          isSelected
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4 sticky top-24">
            ...
            <button
              ...
              className="w-full py-3 bg-gov-navy disabled:opacity-50 text-white font-bold rounded-lg shadow-md transition-all flex items-center justify-center gap-2"
            >
      ...
      {bookingSuccessToken && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full shadow-sm space-y-5 text-center">
            ...
            <div className="p-4 bg-primary-50 rounded-lg border border-primary-200 text-left space-y-2">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg text-xs flex items-center justify-center gap-1.5 shadow"
              >

  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <header className="gov-header sticky top-0 z-50">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 min-h-16 py-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-bold tracking-tight flex items-center gap-1.5">
                  AnnSetu <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/20 text-blue-100 font-bold border border-emerald-500/30">Kisan Portal</span>
                </span>
                <span className="text-xs text-blue-100 block -mt-0.5 font-medium hidden sm:block">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-100 hover:bg-amber-200 text-gov-navy font-bold text-xs shadow-md shadow-amber-950/40   transition-all border border-amber-300"
                title="Toll-Free Helpline & USSD Gateway for Low-Literacy / 2G Phones"
              >
                <PhoneCall className="w-3.5 h-3.5  text-gov-navy" />
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-gov-navy border-t border-emerald-800/80 px-4 pt-3 pb-6 space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 p-2.5 rounded-lg bg-amber-100 hover:bg-amber-200 text-gov-navy font-bold text-xs shadow-md"
            >
      ...
      <footer className="bg-white border-t border-slate-200 py-4 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div>© 2026 AnnSetu • Farmer procurement services</div>
          <div className="flex items-center gap-4 text-slate-400">
            <span>Farmer Portal</span>
            <span>•</span>
            <span>Queue and payment updates</span>
          </div>
        </div>
      </footer>
    </div>

...
-- Insert the procurement centers referenced by the seed farmers
INSERT INTO centers (id, code, name, state_code, daily_capacity, address, active, created_at, updated_at)
VALUES
    ('c8f2620a-258d-47e8-bdd7-0eef8ca41d18', 'PB-LDH-001', 'Ludhiana Grain Market', 'PB', 120,
     '{"line1": "Gill Road Grain Market", "city": "Ludhiana", "state": "Punjab", "pin": "141003"}'::jsonb,
     true, NOW(), NOW()),
    ('41277877-e94e-4cd1-b789-3cb6e6f19be9', 'UP-VNS-001', 'Varanasi Mandi Samiti', 'UP', 100,
     '{"line1": "Pindra Mandi", "city": "Varanasi", "state": "Uttar Pradesh", "pin": "221206"}'::jsonb,
     true, NOW(), NOW()),
    ('4c9e9456-ff03-417c-9c22-2b740a7ce127', 'RJ-JPR-001', 'Jaipur Krishi Upaj Mandi', 'RJ', 80,
     '{"line1": "Chomu Road Mandi", "city": "Jaipur", "state": "Rajasthan", "pin": "302012"}'::jsonb,
     true, NOW(), NOW()),
    ('ecb1fbd8-f467-46c4-b60c-e9d9e465cdb4', 'KA-BGK-001', 'Bagalkot APMC Yard', 'KA', 90,
     '{"line1": "Badami Road APMC", "city": "Bagalkot", "state": "Karnataka", "pin": "587101"}'::jsonb,
     true, NOW(), NOW())
